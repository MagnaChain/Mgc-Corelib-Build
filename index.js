...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'mgc-core' + name : 'mgc-corelib';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/mgc-corelib-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external mgc-corelib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:mgc-corelib -o mgc-corelib.js';
    }
